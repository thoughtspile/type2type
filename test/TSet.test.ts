...
// remove
{
  ...
  expectTypeOf<TSet.remove<TSet<[1, 2, 3]>, 4>>().toEqualTypeOf<
    TSet<[1, 2, 3]>
  >();
}
...
// union
{
  ...
  expectTypeOf<TSet.union<TSet, TSet<[1, 2, 3]>>>().toEqualTypeOf<
    TSet<[1, 2, 3]>
  >();
  expectTypeOf<TSet.union<TSet<[1]>, TSet>>().toEqualTypeOf<TSet<[1]>>();
  expectTypeOf<TSet.union<TSet<[1, 2, 3]>, TSet>>().toEqualTypeOf<
    TSet<[1, 2, 3]>
  >();

  // 2 sets
  expectTypeOf<TSet.union<TSet<[1]>, TSet<[2]>>>().toEqualTypeOf<
    TSet<[2, 1]>
  >();
  expectTypeOf<TSet.union<TSet<[1]>, TSet<[1, 2]>>>().toEqualTypeOf<
    TSet<[1, 2]>
  >();
  expectTypeOf<TSet.union<TSet<[2]>, TSet<[1, 2]>>>().toEqualTypeOf<
    TSet<[1, 2]>
  >();
  expectTypeOf<TSet.union<TSet<[1, 2]>, TSet<[3]>>>().toEqualTypeOf<
    TSet<[3, 1, 2]>
  >();
  expectTypeOf<TSet.union<TSet<[1, 2]>, TSet<[2, 3]>>>().toEqualTypeOf<
    TSet<[2, 3, 1]>
  >();

  // different data types
  expectTypeOf<TSet.union<TSet<[1]>, TSet<[number]>>>().toEqualTypeOf<
    TSet<[number, 1]>
  >();
  expectTypeOf<TSet.union<TSet<[1]>, TSet<[never]>>>().toEqualTypeOf<
    TSet<[never, 1]>
  >();
}
...
// intersection
{
  ...
  expectTypeOf<TSet.intersection<TSet<[1, 2, 3]>>>().toEqualTypeOf<
    TSet<[1, 2, 3]>
  >();
  ...
  expectTypeOf<
    TSet.intersection<TSet, TSet<[1, 2, 3]>>
  >().toEqualTypeOf<TSet>();
  expectTypeOf<TSet.intersection<TSet<[1]>, TSet>>().toEqualTypeOf<TSet>();
  expectTypeOf<
    TSet.intersection<TSet<[1, 2, 3]>, TSet>
  >().toEqualTypeOf<TSet>();

  // 2 sets
  expectTypeOf<TSet.intersection<TSet<[1, 2]>, TSet<[1, 2]>>>().toEqualTypeOf<
    TSet<[1, 2]>
  >();
  expectTypeOf<
    TSet.intersection<TSet<[1, 2]>, TSet<[3, 4]>>
  >().toEqualTypeOf<TSet>();
  expectTypeOf<TSet.intersection<TSet<[1, 2]>, TSet<[1]>>>().toEqualTypeOf<
    TSet<[1]>
  >();
  expectTypeOf<TSet.intersection<TSet<[1, 2]>, TSet<[2]>>>().toEqualTypeOf<
    TSet<[2]>
  >();
  expectTypeOf<
    TSet.intersection<TSet<[1, 2, 4]>, TSet<[2, 3, 4, 5]>>
  >().toEqualTypeOf<TSet<[2, 4]>>();

  // different data types
  expectTypeOf<
    TSet.intersection<TSet<[1]>, TSet<[number]>>
  >().toEqualTypeOf<TSet>();
  expectTypeOf<
    TSet.intersection<TSet<[1]>, TSet<[never]>>
  >().toEqualTypeOf<TSet>();
}
...
// test-difference
{
  ...
  expectTypeOf<TSet.difference<TSet<[1, 2, 3]>>>().toEqualTypeOf<
    TSet<[1, 2, 3]>
  >();

  // 2 sets
  expectTypeOf<
    TSet.difference<TSet<[1, 2]>, TSet<[1, 2]>>
  >().toEqualTypeOf<TSet>();
  expectTypeOf<TSet.difference<TSet<[1, 2]>, TSet<[3, 4]>>>().toEqualTypeOf<
    TSet<[1, 2]>
  >();
  expectTypeOf<TSet.difference<TSet<[1, 2]>, TSet<[1]>>>().toEqualTypeOf<
    TSet<[2]>
  >();
  expectTypeOf<TSet.difference<TSet<[1, 2]>, TSet<[2]>>>().toEqualTypeOf<
    TSet<[1]>
  >();
  expectTypeOf<
    TSet.difference<TSet<[1, 2, 4]>, TSet<[2, 3, 4, 5]>>
  >().toEqualTypeOf<TSet<[1]>>();
}
...
// test-select
{
  ...
  expectTypeOf<TSet.select<TSet<[1, 2]>, number>>().toEqualTypeOf<
    TSet<[1, 2]>
  >();
  expectTypeOf<
    TSet.select<TSet<[1, 2, "a", "b", "c"]>, number>
  >().toEqualTypeOf<TSet<[1, 2]>>();
  expectTypeOf<
    TSet.select<TSet<["a", "b", "c"]>, number>
  >().toEqualTypeOf<TSet>();
}
...
// asUnionType
{
  ...
  expectTypeOf<TSet.asUnionType<TSet<[1, number, "a"]>>>().toEqualTypeOf<
    number | "a"
  >();
}
